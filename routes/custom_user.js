...
router.post('/custom_user/movies_and_series/watchlist', auth, upload.none(), async function(req, res){
   try{
...
router.delete('/custom_user/movies_and_series/watchlist/:materialID/:userName', auth, upload.none(), async function (req,res){
